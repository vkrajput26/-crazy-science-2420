...
const Earrings = () => {
    ...
    useEffect(() => {
        setLoading(true);
        fetch(`https://lovodaapi.herokuapp.com/api/earrings?_page=${page}&_limit=16&_sort=${sort}&_order=${order}&price_gte=${greater}&price_lte=${less}`)
            .then((res) => res.json())
            .then((res)=>{
                setData(res) ;
                setLoading(false);  
    ...
    return (
        ...
        <Box className="main">
            ...
            <Flex my="1.5rem"  fontSize={"sm"} >
                ...
                <Flex w="10%" mt="5px" ml="20px" fontSize="large">856 products</Flex>
            </Flex>
            {/* Products */}
