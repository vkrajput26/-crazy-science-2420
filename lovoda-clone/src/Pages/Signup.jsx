...
<FormControl onSubmit={submitUser}>
   ...
   <Input className='create_btn' onClick={submitUser}  display="block"  cursor="pointer" h={50} borderRadius={1} m="auto" type="submit" bg="black" w="30%" mt={8} color="white" value="Create" />
...
<Box w="100%" h="45px" bg="#ffa100" cursor="pointer" onClick={signInWithGoogle} >
    <Flex ml={10} h="100%" alignItems="center">
  <FaAmazon color='white' size="30px" />
  <Text color="white"  ml={10}>Amazon</Text>
  </Flex>
</Box>
...
<FormControl onSubmit={submitUser}>
   ...
   <Input onClick={submitUser} className='create_btn'  display="block"  cursor="pointer" h={50} borderRadius={1} m="auto" type="submit" bg="black" w="30%" mt={8} color="white" value="Create" />
...
<Box cursor="pointer" onClick={faceBookLogin} w="100%" h="45px" border="2px solid #1877f2">
  ...
  <FaFacebook color='#1877f2' size="30px" />
  <Text color='#1877f2'  fontSize="14px" ml={4}>Continue with Facebook</Text>
  </Flex>
</Box>
<Box w="100%" h="45px" boxShadow='dark-lg' cursor="pointer" onClick={signInWithGoogle} >
    <Flex ml={5} h="100%" alignItems="center">
...
<Box w="100%" h="45px" bg="#ffa100" cursor="pointer" onClick={signInWithGoogle} >
    <Flex ml={5} h="100%" alignItems="center">
  <FaAmazon color='white' size="30px" />
  <Text color="white"  fontSize="14px" ml={10}>Amazon</Text>
  </Flex>
</Box>
