...
const dispatch=useDispatch();
  ...
  return (
    <>
          ...
          <Box width="40%" mt="4rem">
            ...
            <Box border="1px solid grey" mt="2rem" mb="2rem">
              <Box
                ...
                borderRadius="12px"
              >
                <Heading fontWeight="light" as="h6" size="sm">
                  Contact
                </Heading>
                <Heading fontWeight="light" as="h6" size="sm">
                  {user}
            ...
            <Box border="1px solid grey">
              ...
              >
                ...
                <Box display="flex">
                  <Image
                    src="https://cdn.shopify.com/shopifycloud/checkout-web/assets/074315f4e64637ad6544fb57ee4a5a31.svg"
                    alt="visa"
                  />
                  <Image
                    src="https://cdn.shopify.com/shopifycloud/checkout-web/assets/514f6e6c6276bbce83746b13748ab9f5.svg"
                    alt="master"
                  />
                  <Image
                    src="https://cdn.shopify.com/shopifycloud/checkout-web/assets/c4d8f750eff92213f47e4a66f5582d66.svg"
                    alt="am"
                  />
                  <Image
                    src="https://cdn.shopify.com/shopifycloud/checkout-web/assets/d0c08983f01237697642c8d7ad425e44.svg"
                    alt="cs"
                  />
                </Box>
              </Box>
              ...
              <Box ml="1rem" mr="1rem">
                ...
                <Box display="flex">
                  <Radio colorScheme="blue" value="1">
                    <Image
                      width="82px"
                      src="https://brandlogos.net/wp-content/uploads/2022/08/shop_pay-logo_brandlogos.net_tyf5p.png"
                      alt="paypal"
                    />
                  </Radio>
                </Box>
      ...
      <Tablet>
        <Box display="grid" justifyContent="center" gap="2rem">
          <Subtotal />
          <Box width="90%" mt="4rem">
            <Image
              borderRadius="full"
              width="120px"
              height="60px"
      ...
      <Mobile>
        <Box display="grid" justifyContent="center" gap="2rem">
          ...
          <Box width="90%" mt="4rem">
            ...
            {/* do here only */}
            <Box>
              <Box mt="1rem" display="grid" justifyContent="center">
                <Link to="/payment">
                  <Button
                    fontSize="sm"
                    colorScheme="black"
